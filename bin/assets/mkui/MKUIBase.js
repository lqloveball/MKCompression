...
(function(window){
    ...
    EventDispatcher.prototype._eventMap = {};
    /**
    ...
    window.MKUIEventDispatcher = EventDispatcher;
}(window));
/**
 * Event
 */
 ...
 */
(function(window) {
    var MKUIBase = function() {
    };
    MKUIBase.prototype = new MKUIEventDispatcher();
    MKUIBase.prototype._setConfing = function(data, name) {
        if (data != undefined)
            this[name] = data[name] == undefined ? this[name] : data[name];
    };
    window.MKUIBase = MKUIBase;
}(window));